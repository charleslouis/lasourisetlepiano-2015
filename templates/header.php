...
<div class="contain-to-grid">
  ...
  <header id="top" class="top-bar" role="banner">
    <ul class="title-area">
        <li class="name">
        	<h1><a class="brand" id="brand" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a></h1>
        </li>
...
<?php include(locate_template('templates/alerts/alert-contact.php')); ?>
