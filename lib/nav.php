...
/*=============================================
=            Active class custom post types
             related page links in menus       =
=============================================*/

// ADDS ACTIVE CLASS ON PARENT PAGES FOR CUSTOM POSTS
// We want page links such as " Our team " to be active when we look at a single "tem member" custom post
...
{
    if ( is_singular( 'team-member' ) and $item->title == 'Qui nous sommes' ) :
        $classes[] = 'active';
    endif;

    if ( is_singular( 'realisations' ) and $item->title == 'Nos réalisations' ) :
        $classes[] = 'active';
    endif;
