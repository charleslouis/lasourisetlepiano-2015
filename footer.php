	...
	<div class="row">
		<div class="columns">
		  ...
		  <section class="work-w-us-prose">
		    <p><span>Vous avez une petite idée, un grand projet ou un problème que nous pouvons vous aider à résoudre ? </span><span class="work-w-us-prose-invite"><a href="<?php echo esc_url( home_url() ); ?>/contact">Contactez-nous</a>, nous serions ravis d'en discuter avec vous.</span></p>
		  </section>
		  ...
		  <section class="contact-us work-w-us-contact">
		    <ul class="contact-us-list contact-list-footer">
		      ...
		      <li class="contact-us-info icon-map" aria-hidden="true">Ou <a href="<?php echo esc_url( home_url() ); ?>/contact">rendez-nous visite</a></li>
		    </ul>
		  </section>
		</div>
	</div>
	...
	<div class="row">
	  <div class="column">
	    <small class="copy_and_credits">      
	      <span class="credits">Réalisé avec <span class="icon-alone"><i aria-hidden="true" class="icon-heart-fill"></i><span aria-hidden="true" class="screen-reader-text">amour</span></span> par <span class="organisation"><strong>La souris et le piano</strong></span> à <a href="/contactez-nous/"><span class="adress"><span class="ville">Paris</span>, <span class="pays">France</span></span></a>.</span>
